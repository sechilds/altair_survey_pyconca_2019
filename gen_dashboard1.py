...
gender_radio = alt.binding_radio(options = df['Gender'].unique())
class_dropdown = alt.binding_selection(options = df['Class'].unique())
customer_type_dropdown = alt.binding_selection(options = df['Customer Type'].unique())
travel_type_dropdown = alt.binding_selection(options = df['Type of Travel'].unique())
